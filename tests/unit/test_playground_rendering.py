...
APP_PATH = "economic_research_agent/playground/app.py"
...
def test_a2ui_tag_replacements():
    ...
    test_report = "This is a test run [A2UI: RENDER_CHART] and [A2UI: SHOW_METRICS]."
    
    # Matching the logic in app.py
    modified_report = test_report.replace("[A2UI: RENDER_CHART]", "📈 *Chart Generated*")
    modified_report = modified_report.replace("[A2UI: SHOW_METRICS]", "📊 *Metrics Calculated & Visualized*")

...
from economic_research_agent.shared_libraries.typing import InputChat
...
def mock_dependencies() -> Generator[None, None, None]:
    ...
    try:
        try:
            importlib.util.find_spec("economic_research_agent.agent.VertexAIEmbeddings")
        except (
            ModuleNotFoundError,
            ...
            patches.append(patch("economic_research_agent.agent.VertexAIEmbeddings"))
        patches.append(patch("economic_research_agent.agent.ChatVertexAI"))

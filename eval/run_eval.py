...
def run_benchmarks():
    ...
    # The 'agent' exported from economic_research_agent.agent is already the App.
    ...
    for i, test in enumerate(golden_set):
        ...
        try:
            ...
            responses = runner.run(new_message=msg, user_id=f"eval-user", session_id=f"session-{i}")

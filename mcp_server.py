...
from economic_research_agent.tools.hud_skill import analyze_housing_affordability
...
@mcp.tool()
def get_trade_dependency(states: list[str], commodity: str = "Electronic Products"):
...
@mcp.tool()
def get_labor_series(series_ids: list[str], start_year: str = "2023", end_year: str = "2024"):
